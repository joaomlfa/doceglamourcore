...
var clienteJSON;
var delay = 1000;
var valorDescontoAtual = 0;
var dataPedido = new Date();
var dia = ("0" + dataPedido.getDate()).slice(-2);
var mes = ("0" + (dataPedido.getMonth() + 1)).slice(-2);
var dataPedidoConvertido = dataPedido.getFullYear() + "-" + (mes) + "-" + (dia);
...
$("#data_atual_pedido").val(dataPedidoConvertido); // Insere a data atual do sistema em um campo oculto para ser passado como data do pedido.
